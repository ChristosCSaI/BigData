...
schema = "Date STRING, Team_1 STRING, Team_2 STRING, T1_Score INT, T2_Score INT, T1_Sum INT, T1_BP INT, T1_Ratio INT, T1_Srv_Sum INT, T1_Srv_Err INT,
 ...
 T1_Att_Kill INT, T1_Att_Kill_Perc STRING, T1_Att_Eff STRING, T1_Blk_Sum INT, T1_Blk_As INT, T2_Sum INT, T2_BP INT, T2_Ratio INT, T2_Srv_Sum INT, T2_Srv_Err INT,
 T2_Srv_Ace INT, T2_Srv_Eff STRING, T2_Rec_Sum INT, T2_Rec_Err INT, T2_Rec_Pos STRING, T2_Rec_Perf STRING, T2_Att_Sum INT, T2_Att_Err INT, T2_Att_Blk INT, T2_Att_Kill INT,
 T2_Att_Kill_Perc STRING, T2_Att_Eff STRING, T2_Blk_Sum INT, T2_Blk_As INT, Winner INT"
