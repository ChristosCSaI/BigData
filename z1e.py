...
# Calculate the number of matches per count of total sets
matches_per_sets_count = volleyball_df.groupBy("Total_Sets").count()

# Save the result to a CSV file
output_csv_path = "path/to/output/matches_per_sets_count.csv"
matches_per_sets_count.write.csv(output_csv_path, header=True)

# Display the result without cropping
matches_per_sets_count.show(truncate=False)
